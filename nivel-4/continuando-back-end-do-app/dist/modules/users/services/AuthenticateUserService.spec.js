...
describe("CreateUser", function () {
    it("should be able to authenticate", function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeHashProvider, authenticateUser, createUser, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRepository = new FakeUserRepository_1.default();
                    fakeHashProvider = new FakeHashProvider_1.default();
                    authenticateUser = new AuthenticateUserService_1.default(fakeUserRepository, fakeHashProvider);
    ...
    it("should not be able to authenticate with no exist user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeHashProvider, authenticateUser;
        return __generator(this, function (_a) {
            fakeUserRepository = new FakeUserRepository_1.default();
            fakeHashProvider = new FakeHashProvider_1.default();
            authenticateUser = new AuthenticateUserService_1.default(fakeUserRepository, fakeHashProvider);
    ...
    it("should not be able to authenticate with wrong password", function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeHashProvider, authenticateUser, createUser;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fakeUserRepository = new FakeUserRepository_1.default();
