...
var UpdatedUserAvatarService = /** @class */ (function () {
    function UpdatedUserAvatarService(usersRepository, storageProvider) {
        this.usersRepository = usersRepository;
        this.storageProvider = storageProvider;
    }
    UpdatedUserAvatarService.prototype.execute = function (_a) {
    ...
    UpdatedUserAvatarService = __decorate([
        tsyringe_1.injectable(),
        __param(0, tsyringe_1.inject("UsersRepository")),
        __param(1, tsyringe_1.inject("StorageProvider")),
        __metadata("design:paramtypes", [Object, Object])
    ], UpdatedUserAvatarService);
    return UpdatedUserAvatarService;
}());
exports.default = UpdatedUserAvatarService;
