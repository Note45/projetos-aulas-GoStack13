...
var UpdatedUserAvatarService_1 = __importDefault(require("./UpdatedUserAvatarService"));
describe("UpdateUserAvatar", function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    UpdateUserAvatar = new UpdatedUserAvatarService_1.default(fakeUserRepository, fakeStorageProvider);
    ...
    it("should not be able to update avatar when user do not exist", function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    it("should delete old avatar when update new one", function () { return __awaiter(void 0, void 0, void 0, function () {
